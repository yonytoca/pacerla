		...
		<tbody class="contenidobusqueda">
			...
			<tr>				
				...
				<td align="left">
					...
					<button class="btn btn-warning glyphicon glyphicon-pencil btn-xs" data-toggle="modal" data-target="#modalEdicion" onclick="agregaformAgroquimica('<?php echo $datos ?>')"></button>
